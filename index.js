...
function addArtist(array, myName, myYears, myGenre, myNationality, myBio) {
  ...
  array.push({name: myName, years: myYears, genre: myGenre, nationality: myNationality, bio: myBio});
  return array;
}
console.log(artists, 'Texi Schaeffer', '1990-2022', 'Web Developer', 'American', 'I am a civil engineer. I am attending BloomTech to become a full stack developer.');
